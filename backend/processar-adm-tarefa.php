...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $data_estimada = filter_input(INPUT_POST, 'data') ?? null; 
    ...
    try {
        ...
        if ($status_pendente) {
            ...
            header("Location: /FLOWTRACK/Frontend/lista-tarefa/detalhe.php?mensagem=tarefa_adicionada"); // Redirecionar para a lista de tarefas com mensagem
            exit();
        } else {
            
            echo "Erro: Status 'Pendente'";
        }
